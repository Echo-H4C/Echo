...
## 3.4. HTTPS 환경에서 쿠키에 Secure, HttpOnly 속성을 적용

쿠키에 HttpOnly, Secure 옵션을 적용하여 세션 탈취 및 악용 가능성을 최소화한다. HttpOnly 옵션이 적용되면 document.cookie를 통해 쿠키가 노출되지 않아 세션 탈취가 어렵게 된다.
